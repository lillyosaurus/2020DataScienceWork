...
| Title | Person |
|---|---|
| *Forking* Partner | Kyle Bertram |
| *Merging* Partner | Tim Novak |
...
__q1__ (*Both*) Pick a partner in the class, preferably from your learning team. You must mutually agree to complete this exercise together, which will involve *forking* your partner's public repo and making a *pull request*. Copy this file `d14-e-rep05-collab-assignment.Rmd` into the repo you made (in `e-rep02-create`).
